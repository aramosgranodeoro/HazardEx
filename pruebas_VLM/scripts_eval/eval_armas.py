"""
evaluar_modelos_weapons.py
---------------------------
Igual que evaluar_modelos.py pero con LABEL_MAP adaptado a la categoría
"armas" (weapon/no_weapon, arma/no_arma) en vez de violencia.

Uso:
  python evaluar_modelos_weapons.py --input <carpeta_csvs> --output <carpeta_resultados>
"""
...
# Mapa de normalización de etiquetas para la categoría "armas"
LABEL_MAP = {
    "weapon":       "arma",
    "arma":         "arma",
    "gun":          "arma",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Evalúa modelos de clasificación de armas a partir de CSVs de resultados."
    )
    parser.add_argument("--input",  "-i", required=True,
                        help="Carpeta con los CSVs de resultados.")
    parser.add_argument("--output", "-o", default="resultados_evaluacion_weapons",
                        help="Carpeta raíz de salida (default: resultados_evaluacion_weapons).")
...
def plot_classification_metrics(df_summary, output_folder):
    ...
    ax.set_title("Comparación de métricas de clasificación por modelo (armas)",
...
def plot_cost_metrics(df_summary, output_folder):
    ...
    fig.suptitle("Comparación de métricas de coste computacional (media por muestra) — armas",
